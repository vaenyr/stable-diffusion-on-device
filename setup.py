...
package_name = 'sdod'
description = 'Stable-Diffusion On-Device'
author = 'Łukasz Dudziak'
author_email = 'l.dudziak@samsung.com'
url = 'https://github.sec.samsung.net/l-dudziak/snpe-bench-native'
download_url = 'https://github.sec.samsung.net/l-dudziak/snpe-bench-native'
data_files = {}
